...
const SOCKET_PATH =
  "/api/v1/games/fastparty" || "/clients/socketio/hubs/fast_hub";
...
function FastParity() {
  ...
  useEffect(() => {
    ...
    socket.on("secondMod30", (secondMod30, count) => {
      setTimeLeft(secondMod30);
      setPeriod(count);
    });
  ...
  return (
    <div className="col-lg-4 col-md-6 w-full relative">
      <div className="">
        <Header title="Fast-Parity" onButtonClick={handleRuleClick} />
      </div>
